...
class AccountChartTemplate(models.AbstractModel):
    ...
    def _get_ar_account_tags(self):
        ...
        tags = {
            ...
            "ventas": self.env.ref(f"{prefix}.ar_eerr_ventas"),
            "costo_ventas": self.env.ref(f"{prefix}.ar_eerr_costo_ventas"),
            "gastos_comercializacion": self.env.ref(f"{prefix}.ar_eerr_gastos_comercializacion"),
            "gastos_administracion": self.env.ref(f"{prefix}.ar_eerr_gastos_administracion"),
            "otros_gastos": self.env.ref(f"{prefix}.ar_eerr_otros_gastos"),
            "resultados_financieros": self.env.ref(f"{prefix}.ar_eerr_rxt_resultados_financieros"),
            "otros_ingresos_egresos": self.env.ref(f"{prefix}.ar_eerr_otros_ingresos_egresos"),
            "impuesto_ganancias": self.env.ref(f"{prefix}.ar_eerr_impuesto_ganancias"),
            # Balance Sheet tags (Estado Patrimonial)
            "caja_bancos": self.env.ref(f"{prefix}.ar_esp_caja_y_bancos"),
            "inversiones_temporarias": self.env.ref(f"{prefix}.ar_esp_inversiones_temporarias"),
            "creditos_ventas": self.env.ref(f"{prefix}.ar_esp_creditos_por_ventas"),
            "otros_creditos": self.env.ref(f"{prefix}.ar_esp_otros_creditos"),
            "bienes_cambio": self.env.ref(f"{prefix}.ar_esp_bienes_de_cambio"),
            "otros_activos": self.env.ref(f"{prefix}.ar_esp_otros_activos"),
            "creditos_ventas_nc": self.env.ref(f"{prefix}.ar_esp_creditos_por_ventas_nc"),
            "otros_creditos_nc": self.env.ref(f"{prefix}.ar_esp_otros_creditos_nc"),
            "bienes_cambio_nc": self.env.ref(f"{prefix}.ar_esp_bienes_de_cambio_nc"),
            "bienes_uso": self.env.ref(f"{prefix}.ar_esp_bienes_de_uso"),
            "participaciones_sociedades": self.env.ref(f"{prefix}.ar_esp_participaciones_en_sociedades"),
            "otras_inversiones_nc": self.env.ref(f"{prefix}.ar_esp_otras_inversiones_nc"),
            "activos_intangibles": self.env.ref(f"{prefix}.ar_esp_activos_intangibles"),
            "otros_activos_nc": self.env.ref(f"{prefix}.ar_esp_otros_activos_nc"),
            "llave_negocio": self.env.ref(f"{prefix}.ar_esp_llave_de_negocio"),
            "deudas_comerciales": self.env.ref(f"{prefix}.ar_esp_deudas_comerciales"),
            "prestamos": self.env.ref(f"{prefix}.ar_esp_prestamos"),
            "remun_cargas_sociales": self.env.ref(f"{prefix}.ar_esp_remun_y_cargas_sociales"),
            "cargas_fiscales": self.env.ref(f"{prefix}.ar_esp_cargas_fiscales"),
            "anticipos_clientes": self.env.ref(f"{prefix}.ar_esp_anticipos_de_clientes"),
            "dividendos_pagar": self.env.ref(f"{prefix}.ar_esp_dividendos_a_pagar"),
            "otras_deudas": self.env.ref(f"{prefix}.ar_esp_otras_deudas"),
            "previsiones": self.env.ref(f"{prefix}.ar_esp_previsiones"),
            "deudas_nc": self.env.ref(f"{prefix}.ar_esp_deudas_no_corrientes"),
            "previsiones_nc": self.env.ref(f"{prefix}.ar_esp_previsiones_no_corrientes"),
            "patrimonio_neto": self.env.ref(f"{prefix}.ar_esp_patrimonio_neto"),
        }
        return tags
